    ...
    items: [
      {
        ...
        answer:
          "Our photo tiles are custom printed and typically shipped within 5 days. Delivery times may vary slightly depending on production volume and location, but most orders are dispatched within this timeframe.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "You may edit or modify your order until it enters the printing stage. Once the product has been printed, changes or cancellations are no longer possible due to the custom-made nature of the product.",
      },
    ],
    ...
    items: [
      {
        ...
        answer:
          "แผ่นภาพของเราถูกพิมพ์ขึ้นตามสั่งและโดยปกติจะจัดส่งภายใน 5 วัน ระยะเวลาการจัดส่งอาจแตกต่างกันเล็กน้อยขึ้นอยู่กับปริมาณการผลิตและสถานที่ตั้ง แต่คำสั่งซื้อส่วนใหญ่จะถูกส่งออกภายในกรอบเวลานี้",
      },
      {
      ...
      },
      {
        ...
        answer:
          "คุณสามารถแก้ไขหรือเปลี่ยนแปลงคำสั่งซื้อได้จนกว่าจะเริ่มขั้นตอนการพิมพ์ เมื่อสินค้าถูกพิมพ์แล้ว จะไม่สามารถเปลี่ยนแปลงหรือยกเลิกได้เนื่องจากเป็นสินค้าที่ผลิตขึ้นตามสั่งโดยเฉพาะ",
      },
    ],
...
type LangKey = keyof typeof SUPPORT_CONTENT;

function SupportUI() {
  const { language } = useApp() as { language?: string };

  const lang = ((language || "EN").toUpperCase() as LangKey) || "EN";
  const content = SUPPORT_CONTENT[lang] || SUPPORT_CONTENT.EN;
      ...
      <div style={{ display: "flex", flexDirection: "column", minHeight: "calc(100vh - 64px)" }}>
        <div className="container" style={{ padding: "6rem 1rem", maxWidth: "800px", flex: 1 }}>
          ...
          >
            ...
            <a
              href="mailto:support@memotiles.com"
              style={{
