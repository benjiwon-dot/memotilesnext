export const translations = {
    EN: {
        ...
        aboutHeroSubtitle: "Memotile are photo tiles that turn memories with loved ones into the atmosphere and emotion of your home.",
        aboutSection2Title: "Designed for the images you love",
        aboutSection2Body: "From moments of travel and family expressions to images that remind you of your loved ones. Memotile are designed for impressive images and poster-style displays in personal spaces.",
        ...
        aboutSection4Body: "Memotile is more than just wall decor. It makes a sensible gift for loved ones on moving days, anniversaries, and special occasions. Create a meaningful choice that stays in the recipient's space for a long time.",
        aboutSection5Title: "Our belief",
        aboutSection5Body: \"We believe that images should be experienced in space, not just stored. Memotile naturally blends into your space and the daily life of your loved ones.\",
    ...
    TH: {
        ...
        aboutHeroSubtitle: "Memotile คือแผ่นภาพถ่ายที่เปลี่ยนความทรงจำกับคนที่คุณรัก ให้กลายเป็นบรรยากาศและความรู้สึกภายในบ้าน",
        aboutSection2Title: "ออกแบบมาเพื่อภาพที่คุณรัก",
        aboutSection2Body: "ตั้งแต่ช่วงเวลาแห่งการเดินทาง รอยยิ้มของครอบครัว ไปจนถึงภาพที่ทำให้คุณนึกถึงคนที่รัก Memotile ถูกออกแบบมาเพื่อการจัดวางภาพที่ประทับใจในสไตล์โปสเตอร์ภายในพื้นที่ส่วนตัวของคุณ",
        ...
        aboutSection4Body: "Memotile เป็นมากกว่าแค่ของตกแต่งผนัง แต่เป็นของขวัญที่เปี่ยมด้วยรสนิยมสำหรับคนที่คุณรักในวันขึ้นบ้านใหม่ วันครบรอบ หรือโอกาสพิเศษ สร้างตัวเลือกที่มีความหมายซึ่งจะคงอยู่ในพื้นที่ของผู้รับไปอีกนาน",
        aboutSection5Title: "ความเชื่อของเรา",
        aboutSection5Body: "เราเชื่อว่ารูปภาพไม่ควรเป็นเพียงสิ่งที่ถูกบันทึกไว้ แต่ควรได้รับการสัมผัสในพื้นที่จริง Memotile จะกลมกลืนเข้ากับพื้นที่ของคุณและชีวิตประจำวันของคนที่คุณรักอย่างเป็นธรรมชาติ",
